...
<body>
    ...
    <div class="image-container my-8" style="width: 80;"> 
    <!-- <img src="../image/books.gif" alt="Books" loading="lazy" class="responsive-image"> -->
</div>
        <div class="mt-20 px-28">
            <form class=" mx-auto px-24" method="POST" enctype="multipart/form-data" action="<?php $_SERVER['PHP_SELF'] ?>">
